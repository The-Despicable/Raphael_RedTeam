...
export type AppState = DeepImmutable<{
  ...
  // Raphael mode/persona/opsec state
  raphaelMode: 'autonomous' | 'recon' | 'community' | 'debate' | 'rsi' | 'persona' | undefined
  raphaelPersona: 'stealth' | 'aggressive' | 'z3r0' | undefined
  raphaelTarget: string | undefined
  raphaelOpsec: {
    tor?: boolean
    proxy?: string
    jitter?: { min: number; max: number }
    defaultToolFlags?: Record<string, any>
  } | undefined
...
export function getDefaultAppState(): AppState {
  ...
  return {
    ...
    agent: undefined,
    // Raphael mode/persona/opsec defaults
    raphaelMode: 'autonomous',
    raphaelPersona: 'stealth',
    raphaelTarget: undefined,
    raphaelOpsec: {
      tor: true,
